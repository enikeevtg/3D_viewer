...
# SERVICE
style:
	clang-format --style=google -n *.h *.c $(MODEL_LOAD_SRC) $(UI_DIR)*.h $(UI_DIR)*.cpp $(TESTS_SRC)

gost:
	clang-format --style=google -i *.h *.c $(MODEL_LOAD_SRC) $(UI_DIR)*.h $(UI_DIR)*.cpp $(TESTS_SRC)
